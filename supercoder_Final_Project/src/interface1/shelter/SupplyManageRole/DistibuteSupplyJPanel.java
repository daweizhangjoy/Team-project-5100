...
public class DistibuteSupplyJPanel extends keeptoo.KGradientPanel {
    ...
    DistibuteSupplyJPanel(KGradientPanel userProcessContainer, UserAccount account, Organization organization, ShelterEnterprise shelterEnterprise, Network network, EcoSystem business, TotalSupply supply) {
        initComponents();
